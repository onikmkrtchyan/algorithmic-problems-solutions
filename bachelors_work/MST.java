...
/**
 * The problem is, Minimum spanning tree search problem of square grid with weighted edges
 */
class MST {
    ...
    public static int[] findLengthAndWidth() {
        ...
        try {
            file = new FileReader(System.getProperty("user.dir") + "/src/DiplomaWork/spanningTree.txt");
    ...
    int[][] fileRead() throws Exception {
        FileReader file = new FileReader(System.getProperty("user.dir") + "/src/DiplomaWork/spanningTree.txt");
    ...
    /**
     * Function that checks,does given graph is square grid or not:
     *
